...
Dynamic_calls.oPDrone_Step_2 = memory.dynamic_call("int64_t", {"CInstance*", "CInstance*"},
...
Dynamic_calls.oDrifterCube_Create_0 = memory.dynamic_call("int64_t", {"CInstance*", "CInstance*"},
